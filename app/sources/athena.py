"""Athena Immo source adapter — Tier 3 (Wallonia premium agency)."""
...
class AthenaSource(BaseSource):
    """Scraper for Athena Immo — premium property agency in Brabant Wallon and Brussels area."""
