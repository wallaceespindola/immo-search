"""Sotheby's International Realty Belgium source adapter — Tier 3 (luxury)."""
...
class SothebysSource(BaseSource):
    """Scraper for Sotheby's International Realty Belgium — luxury segment."""
        ...
        for card in cards:
            try:
                ...
                if url and not url.startswith("http"):
                    url = f"https://www.sothebysrealty.be{url}"

                title_el = card.select_one("h2, h3, .property-title, .listing-title")
