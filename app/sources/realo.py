"""Realo source adapter — Tier 3 aggregator."""
...
class RealoSource(BaseSource):
    """Scraper for Realo.be — Belgian property aggregator."""

    name = "Realo"
    tier = 3

    _SEARCH_URL = "https://www.realo.be/fr/recherche/vente"
    ...
    def _parse_results(self, soup) -> list[Listing]:
        listings = []
        cards = soup.select("div.property-card, article, li.result-item")
