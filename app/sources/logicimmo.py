"""Logic-Immo Belgium source adapter — Tier 2."""
...
class LogicImmoSource(BaseSource):
    """Scraper for Logic-Immo.be — Tier 2 opportunity source."""

    name = "Logic-Immo"
    tier = 2

    _SEARCH_URL = "https://www.logic-immo.be/fr/vente/maison/brabant-wallon"
    ...
    def _parse_results(self, soup) -> list[Listing]:
        listings = []
        cards = soup.select("div.property-thumb, article.product-card, li.search-item")
        ...
        for card in cards:
            try:
                ...
                if url and not url.startswith("http"):
                    url = f"https://www.logic-immo.be{url}"
